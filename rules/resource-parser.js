...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    ...
    "🇦🇪": ["United Arab Emirates", "阿联酋","AE ", "迪拜", "阿联酋", "Dubai"],
    "🇧🇷": ["BR", "Brazil", "巴西", "圣保罗"],
    ...
    "🇸🇾": ["叙利亚", "叙利亚", " SY "],
    "🇱🇧": ["黎巴嫩","LB", "Lebanon"],
    "🇧🇳": ["文莱","汶莱", "BRN","Negara Brunei Darussalam"],
    "🇨🇻": ["佛得角"],
    "🇸🇷": ["苏里南","苏里南"],
    "🇲🇨": ["摩纳哥","摩纳哥"],
    "🇯🇲": ["牙买加","牙买加 "],
